...
## Installing
- Download WineStaging9.18.flatpak, WineStaging.mono9.3.0.flatpak, and WineStaging.gecko2.47.4.flatpak from releases
- Install WineStaging9.18.flatpak, WineStaging.mono9.3.0.flatpak, and WineStaging.gecko2.47.4.flatpak (sudo needed for installing single use Flatpak bundle)
```console
sudo flatpak install WineStaging9.18.flatpak
```
```console
